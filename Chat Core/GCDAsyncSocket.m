...
- (void)setDelegate:(id<GCDAsyncSocketDelegate>)newDelegate synchronously:(BOOL)synchronously
{
...
- (void)ssl_startTLS
{
	...
	BOOL isServer = [tlsSettings[(__bridge NSString *)kCFStreamSSLIsServer] boolValue];
	...
	value = tlsSettings[(__bridge NSString *)kCFStreamSSLPeerName];
	...
	value = tlsSettings[(__bridge NSString *)kCFStreamSSLAllowsAnyRoot];
	#pragma clang diagnostic pop
	if (value)
	{
	...
	#pragma clang diagnostic push
	#pragma clang diagnostic ignored "-Wdeprecated-declarations"
	value = tlsSettings[(__bridge NSString *)kCFStreamSSLAllowsExpiredRoots];
	#pragma clang diagnostic pop
	if (value)
	{
	...
	#pragma clang diagnostic push
	#pragma clang diagnostic ignored "-Wdeprecated-declarations"
	value = tlsSettings[(__bridge NSString *)kCFStreamSSLValidatesCertificateChain];
	#pragma clang diagnostic pop
	if (value)
	{
	...
	#pragma clang diagnostic push
	#pragma clang diagnostic ignored "-Wdeprecated-declarations"
	value = tlsSettings[(__bridge NSString *)kCFStreamSSLAllowsExpiredCertificates];
	#pragma clang diagnostic pop
	if (value)
	{
	...
	#pragma clang diagnostic push
	#pragma clang diagnostic ignored "-Wdeprecated-declarations"
	value = tlsSettings[(__bridge NSString *)kCFStreamSSLLevel];
	#pragma clang diagnostic pop
	if (value)
	{
