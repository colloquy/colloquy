...
- (void) windowDidLoad {
	...
	[[favoritesButton cell] setAccessibilityRoleDescription:NSLocalizedString(@"Favorites", nil)];

	[[viewActionButton cell] setAccessibilityRoleDescription:NSLocalizedString(@"Actions", nil)];
